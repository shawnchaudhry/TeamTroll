...
public class Player implements Serializable {
     ...
     * 
     * @param Hashtable<String, Integer> inventory The inventory to be set.
     */
    ...
    /**
     * Helper method to generate a string representing the contents of the inventory.
     */
    ...
    /**
     * Helper method to generate a string that displays the first half 
     * of the items in the inventory.
     *
     * @return String A string representing the first half of the contents of the inventory.
     */
    ...
    /**
     * Helper method to generate a string that displays the second half 
     * of the items in the inventory.
     *
     * @return String A string representing the second half of the contents of the inventory.
     */
     ...
     * 
     * @param Ship ship The ship to be set.
     */
